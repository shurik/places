...
tinyMCE.init({
    ...
    // General
    mode: "exact",
    elements: "id_content, id_site-siteconfiguration-content_type-object_id-0-description, id_site-siteconfiguration-content_type-object_id-0-contact",
    theme :             'advanced',
    skin:               'grappelli',
    dialog_type:        'modal',
    ...
    language:           "en",
    relative_urls:      false,
    plugins:            'inlinepopups,advimage,advlink,fullscreen,paste,media,searchreplace,grappelli,grappelli_contextmenu,template',
    ...
    theme_advanced_buttons1: "formatselect,styleselect,|,justifyleft,justifycenter,justifyright,justifyfull,|,bold,italic,underline,|,bullist,numlist,blockquote,|,undo,redo,|,link,unlink,|,image,|,fullscreen,|,grappelli_adv",
